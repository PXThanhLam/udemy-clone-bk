...
CREATE TABLE IF NOT EXISTS tbl_COURSE_TOPIC (
	...
	topic 		VARCHAR(256) 	NOT NULL 	DEFAULT "Default Topic",
...
-- --
-- ADD CARD FOR PAYMENT , COUNTRY IS A LIST OF ALL COUNTRY IN THE WORD --
...
CREATE TABLE IF NOT EXISTS tbl_CARD(
    id 				INT UNSIGNED	NOT NULL AUTO_INCREMENT,
    expired_date    TIMESTAMP       NOT NULL,
    country         CHAR(2) NOT NULL REFERENCES tbl_COUNTRY(country_code),
